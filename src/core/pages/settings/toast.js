...
const ICONS = {
  ...
  [ERROR]: `<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    <path d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm0 2.5a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0v-4A.75.75 0 0 1 8 3.5zm0 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
  </svg>`,
  [INFO]: `<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    <path d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm0 3a.75.75 0 1 1 0 1.5A.75.75 0 0 1 8 4zm1.5 8h-3a.5.5 0 0 1 0-1h1V7.5h-.5a.5.5 0 0 1 0-1H8a.5.5 0 0 1 .5.5V11h1a.5.5 0 0 1 0 1z"/>
  </svg>`,
};
...
function createToast(message, type) {
  ...
  dismissBtn.innerHTML = `<svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
